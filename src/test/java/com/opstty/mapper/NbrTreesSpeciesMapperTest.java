...
public class NbrTreesSpeciesMapperTest {
    @Mock
    private Mapper.Context context;
    private NbrTreesSpeciesMapper nbrTreesSpeciesMapper;

    @Before
    public void setup() {
        this.nbrTreesSpeciesMapper = new NbrTreesSpeciesMapper();
    }
    ...
    public void testMap() throws IOException, InterruptedException {
        ...
        this.nbrTreesSpeciesMapper.map(null, new Text(value), this.context);
